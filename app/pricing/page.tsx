...
export const metadata: Metadata = {
	...
	description: "Transparent pricing for professional gemological services. From initial consultations (€70) to comprehensive analysis (€300) with Raman spectroscopy, X-ray diffraction, and detailed certificates.",
	openGraph: {
